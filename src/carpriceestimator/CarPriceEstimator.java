...
public class CarPriceEstimator {
    ...
    public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven, 
        ...
        boolean hasAccidentHistory) {
            ...
            //     reduce price by $500
            if (hasAccidentHistory) salePrice -= 500;
    ...
    public static void main(String[] args) {
        ...
        double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2018,
                60000.0, 2, true, false, true, false, false, true);
    }
